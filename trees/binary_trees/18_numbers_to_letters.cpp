//PROBLEM: Gien a set of positive numbers, find all possible combinations of words formed by replacing the continous digits with corresponding charcter of english alphabet. i.e. subset {1} can be replaced by A, {2} can be replaced by B, {1,0} can be replaced J, {2,1} can be replaced U, etc..
//
//EARLY NOTES: 
//
//PLANNING:
